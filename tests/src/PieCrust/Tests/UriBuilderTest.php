...
class UriBuilderTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function tagSlugifyDataProvider()
    {
        return array(
            ...
            array('foo bar!', 'foo-bar', 'encode|res2dash'),
            array('foo/bar,OY', 'foo-bar-OY', 'encode|res2dash'),
            array('épatant/écart', '%C3%A9patant-%C3%A9cart', 'encode|res2dash'),
            array('foo/bar,OY', 'foo-bar-OY', 'encode|res2dash'),
            array('épaTANT', '%C3%A9paTANT', 'encode|res2dash'),
