 ...
 */
class SimpleFileProcessor implements IFileProcessor
{
    protected $pieCrust;
    protected $name;
    protected $priority;
    ...
    public function __construct($name, $inputExtensions, $outputExtensions, $priority = IFileProcessor::PRIORITY_DEFAULT)
    {
